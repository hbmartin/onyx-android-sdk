...
public class PackageUtils
{
    ...
    private static boolean a(final PackageInstaller packageInstaller, final int sessionId, final String apkFilePath) {
        ...
        //    21: invokevirtual   android/content/pm/PackageInstaller.openSession:(I)Landroid/content/pm/PackageInstaller$Session;
        //    24: dup            
        //    25: astore_3       
        //    26: aload           5
        //    28: dup            
        ...
        //    42: lload           6
        //    44: lload           8
        //    46: invokevirtual   android/content/pm/PackageInstaller$Session.openWrite:(Ljava/lang/String;JJ)Ljava/io/OutputStream;
        //    49: astore_1       
        //    50: new             Ljava/io/FileInputStream;
        //    53: dup            
        //    54: astore_2       
        //    55: aload           5
        ...
        //    90: iconst_0       
        //    91: iload           6
        //    93: invokevirtual   java/io/OutputStream.write:([BII)V
        //    96: goto            69
        //    99: aload_3        
        //   100: aload_2        
        //   101: aload_1        
        //   102: aload_3        
        //   103: aload_1        
        //   104: invokevirtual   android/content/pm/PackageInstaller$Session.fsync:(Ljava/io/OutputStream;)V
        //   107: ldc             Lcom/onyx/android/sdk/utils/PackageUtils;.class
        ...
        //   139: invokestatic    com/onyx/android/sdk/utils/Debug.i:(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)V
        //   142: iconst_1       
        //   143: istore          4
        //   145: invokestatic    com/onyx/android/sdk/utils/FileUtils.closeQuietly:(Ljava/io/Closeable;)V
        //   148: invokestatic    com/onyx/android/sdk/utils/FileUtils.closeQuietly:(Ljava/io/Closeable;)V
        //   151: invokestatic    com/onyx/android/sdk/utils/FileUtils.closeQuietly:(Ljava/io/Closeable;)V
        //   154: goto            182
        //   157: goto            167
        //   160: aload_0        
        //   161: astore_2       
        ...
        //   165: aload_0        
        //   166: astore_2       
        //   167: invokevirtual   java/lang/Exception.printStackTrace:()V
        //   170: aload_3        
        //   171: aload_2        
        //   172: aload_1        
        //   173: invokestatic    com/onyx/android/sdk/utils/FileUtils.closeQuietly:(Ljava/io/Closeable;)V
        ...
        //   186: aload_2        
        //   187: aload_1        
        //   188: invokestatic    com/onyx/android/sdk/utils/FileUtils.closeQuietly:(Ljava/io/Closeable;)V
        //   191: invokestatic    com/onyx/android/sdk/utils/FileUtils.closeQuietly:(Ljava/io/Closeable;)V
        //   194: invokestatic    com/onyx/android/sdk/utils/FileUtils.closeQuietly:(Ljava/io/Closeable;)V
        //   197: athrow         
        //    StackMapTable: 00 08 FF 00 45 00 06 01 07 02 07 07 02 01 07 00 13 01 07 02 09 00 00 FA 00 1D FF 00 39 00 05 00 07 02 07 07 02 01 07 00 13 01 00 01 07 02 2A FF 00 02 00 04 07 02 01 07 02 07 00 07 00 13 00 01 07 02 2C FF 00 04 00 05 07 02 01 07 02 07 00 07 00 13 01 00 01 07 02 2A FF 00 01 00 05 00 07 02 07 07 02 01 07 00 13 01 00 01 07 02 2A FF 00 0E 00 05 00 00 00 00 01 00 00 FF 00 02 00 04 00 07 02 07 07 02 01 07 00 13 00 01 07 02 2C
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type                 
        //  -----  -----  -----  -----  ---------------------
        //  11     14     165    167    Ljava/lang/Exception;
        //  11     14     160    165    Any
        //  17     24     165    167    Ljava/lang/Exception;
        //  17     24     160    165    Any
        //  26     32     165    167    Ljava/lang/Exception;
        //  26     32     160    165    Any
        //  36     39     165    167    Ljava/lang/Exception;
        //  36     39     160    165    Any
        //  41     49     165    167    Ljava/lang/Exception;
        //  41     49     160    165    Any
        //  50     53     165    167    Ljava/lang/Exception;
        //  50     53     160    165    Any
        //  55     60     165    167    Ljava/lang/Exception;
        //  55     60     160    165    Any
        //  62     67     157    160    Ljava/lang/Exception;
        //  62     67     185    198    Any
        //  69     75     157    160    Ljava/lang/Exception;
        //  69     75     185    198    Any
        //  90     142    157    160    Ljava/lang/Exception;
        //  90     142    185    198    Any
        //  167    170    185    198    Any
        // 
        // The error that occurred was:
        // 
        // java.lang.IllegalStateException: Inconsistent stack size at #0167 (coming from #0197).
