...
CRATE="$ROOT/onyxsdk-pen/native/onyx-pen-touch-reader"
...
build_one() {
  ...
  cp "$CRATE/target/$target/release/libonyx_pen_touch_reader.so" \
...
echo "Recovered Rust JNI libraries are in $OUTPUT_ROOT"
