...
/* JADX INFO: loaded from: classes.jar:com/onyx/android/sdk/api/device/EpdSDM.class */
public class EpdSDM extends EpdDevice {
    ...
    public void applyDeepGCUpdate(View view) {
        EpdController.setViewDefaultUpdateMode(view, UpdateMode.DEEP_GC);
    }
