...
class OnyxAndroidLibraryPlugin : Plugin<Project> {
    ...
    private fun Project.configurePublication(registry: OnyxRegistry, module: OnyxModule) {
        ...
        afterEvaluate {
            val publication = createReleasePublication(registry, module)
            configureCentralStagingRepository()
            configurePublicationSigning(publication)
        }
    }

    private fun Project.createReleasePublication(
        registry: OnyxRegistry,
        module: OnyxModule,
    ): MavenPublication = extensions.getByType<PublishingExtension>()
        .publications
    ...
    private fun Project.configureCentralStagingRepository() {
    ...
    private fun Project.configurePublicationSigning(publication: MavenPublication) {
